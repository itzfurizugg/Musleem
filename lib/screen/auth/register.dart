  ...
  void _showInfoDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Daftarkan akun kamu untuk mulai perjalanan ibadah bersama Musleem. Setelah mendaftar, kamu akan menerima kode OTP 6 digit ke email untuk verifikasi akun.',
        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: isDark
                    ...
                    : [Colors.white.withOpacity(0.35), Colors.white.withOpacity(0.10)],
              ),
              borderRadius: BorderRadius.circular(50),
              border: Border.all(
            ...
            child: DefaultTextStyle(
              ...
              child: IconTheme(
                data: IconThemeData(color: theme.colorScheme.onSurface, size: 16),
                child: child,
              ),
            ),
          ),
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: hint,
        hintStyle: TextStyle(color: theme.brightness == Brightness.dark ? Colors.white54 : Colors.grey[500], fontSize: 14),
