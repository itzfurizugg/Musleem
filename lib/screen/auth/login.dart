          ...
          AnimatedPositioned(
            ...
            child: ColorFiltered(
              colorFilter: ColorFilter.mode(
                Colors.black.withOpacity(theme.brightness == Brightness.dark ? 0.6 : 0.0),
                BlendMode.darken,
              ),
              child: Image.asset(
              ...
              errorBuilder: (context, error, stackTrace) => Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [theme.colorScheme.primary, const Color(0xFF0D4A4A)],
                  ),
                ),
                child: Center(
                  child: Icon(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 15), // ← jarak lebih jauh
                          // Daftar Link
                          Center(
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(icon, color: theme.brightness == Brightness.dark ? Colors.white70 : theme.colorScheme.primary, size: 20),
