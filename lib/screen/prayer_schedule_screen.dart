        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: FloatingActionButton.extended(
              ...
              backgroundColor: const Color(0xFFFBFAF8).withOpacity(0.7),
            ...
            Center(
              child: SmoothPageIndicator(
                ...
                effect: ExpandingDotsEffect(
                  dotHeight: 8,
                  dotWidth: 8,
                  activeDotColor: Theme.of(context).brightness == Brightness.dark ? Colors.white70 : Theme.of(context).colorScheme.primary,
                  dotColor: Theme.of(context).brightness == Brightness.dark ? Colors.white24 : Colors.grey.shade300,
                ),
              ),
            ),
